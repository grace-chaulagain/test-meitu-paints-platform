...
function Utilities() {
  ...
  const filtered = useMemo(() => {
    ...
    if (!q) return paintUtilities;
    return paintUtilities.filter((p) =>
      ...
      <div className="regular-hero">
        <div className="container py-5">
          ...
          <div className="d-flex flex-column flex-lg-row align-items-lg-end justify-content-between gap-3 mb-4">
            <div>
              <div className="kicker">Utilities Series</div>
              <h1 className="title fw-bold mb-2">Painting Tools & Utilities</h1>
              <p className="text-muted mb-0">
                Essential tools and accessories that make painting perfect.
              </p>
            </div>
          ...
          <div className="control-bar glass-card rounded-4 p-3 p-md-4 shadow-sm mb-4">
            ...
            <div className="d-flex justify-content-between align-items-center mt-3">
              ...
              <span className="small text-muted">
                Category: <span className="fw-semibold">Utilities</span>
              </span>
            </div>
          </div>
                  ...
                  <div className="product-tile">
                    ...
                    <div className="tile-head">
                      <div className="tile-meta">
                        <span className="meta-chip">Utilities</span>
                        {product.size && (
