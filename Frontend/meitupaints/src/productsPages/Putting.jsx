...
function Putting() {
  ...
  const productsToDisplay = useMemo(() => {
    if (selectedCategory === "Exterior") return exteriorPutting;
    if (selectedCategory === "Interior") return interiorPutting;
    return roadMarking;
  }, [selectedCategory]);
      ...
      <div className="regular-hero">
        <div className="container py-5">
          ...
          <div className="d-flex flex-column flex-lg-row align-items-lg-end justify-content-between gap-3 mb-4">
            <div>
              <div className="kicker">Putting Series</div>
              <h1 className="title fw-bold mb-2">
                Interior & Exterior Puttings
              </h1>
              ...
              <div className="col-lg-6">
                ...
                <div className="segmented" role="tablist" aria-label="Category">
                  ...
                  <button
                    type="button"
                    className={`seg-btn ${
                      selectedCategory === "RoadMarking" ? "active" : ""
                    }`}
                    onClick={() => setSelectedCategory("RoadMarking")}
                  >
                    Road Marking
                  </button>
                </div>
